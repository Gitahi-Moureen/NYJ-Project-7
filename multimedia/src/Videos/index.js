...
const Videos = ()=>{
    return(
                ...
                <p className="text"><b>Episode 2:</b> Features of chatGPT and<br></br> how the product generates revenue.
                ...
                <p className="text"><b>Episode 3: </b>Positives and shortcomings <br></br>of chatGPT and the User experience.
</p>
...
<div className="vidLine2">
                ...
                <p className="text"><b>Episode 4:</b> The use case and impact of chatGPT</p>
